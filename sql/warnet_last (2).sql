...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 02, 2026 at 07:28 AM
...
ALTER TABLE `billing_sessions`
  ...
  ADD CONSTRAINT `billing_sessions_ibfk_2` FOREIGN KEY (`customer_id`) REFERENCES `members` (`id`),
  ADD CONSTRAINT `billing_sessions_ibfk_3` FOREIGN KEY (`operator_id`) REFERENCES `operators` (`id`);
...
ALTER TABLE `payments`
  ...
  ADD CONSTRAINT `payments_ibfk_2` FOREIGN KEY (`operator_id`) REFERENCES `operators` (`id`);
COMMIT;
