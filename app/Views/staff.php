                ...
                <?php foreach ($operators as $operator): ?>
                    <tr class="hover:bg-slate-800 border-b border-slate-700">
                        ...
                        <td class="pt-2 px-3 font-semibold text-right flex justify-end">
                            <a href="<?= base_url('staff/edit?id=' . $operator['id']) ?>"
                            ...
                            <a onclick="openStaffDelete(<?= $operator['id'] ?>)"
                                class="rounded-lg bg-red-500 pt-1 pb-2 px-2 ml-2 hover:bg-red-700 hover:text-gray-300 flex cursor-pointer"><ion-icon
                                    class="pt-1 text-2xl" name="trash-outline"></ion-icon></a>
                        </td>
                    </tr>
                <?php endforeach ?>
            <?php else: ?>
...
<dialog id="dialog-delete"
    ...
    <form action="<?= base_url('/staff/delete') ?>" method="POST"
